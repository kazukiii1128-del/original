...
# ── ヘッダー ─────────────────────────────────────────────────────────────────
H = ["カテゴリ","優先度","#","社名","規模・店舗数","主要エリア",
     "本社所在地","電話番号","卸・問い合わせ先","公式URL",
     "情報ソース（どこで調べたか）","SNSアカウント","担当者情報","アプローチメモ"]

# ── データ 40社 ───────────────────────────────────────────────────────────────
# 列順: カテゴリ, 優先度, #, 社名, 規模, エリア, 本社, TEL, 卸/問合, URL, ソース, SNS, 担当者, アプローチ
rows = [
